...
import { injectGooglePlayServices, injectAndroidEnvironment } from '@/utils'
      ...
      try {
        gameWindow.initDofus(() => {
          ...
          try {
            ...
            injectAndroidEnvironment(gameWindow);
            ...
            window.lindoAPI.logger.error('Failed to inject emulation: ' + error)();
          }
          ...
          try {
            ...
            window.lindoAPI.logger.error('Failed to initialize game manager: ' + error)();
          }
        });
      } catch (error) {
        window.lindoAPI.logger.error('Failed to initialize Dofus: ' + error)();
      }
    }
  }
